   ...
   <div class="modal" id="addItemModal" tabindex="-1" role="dialog" style="display: none;">
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Event Participants Details') }}
        </h2>

    </x-slot>
	
	<div class='container'>
                    <h1 style="font-size: 24px;">Event Name: {{ $event->name }}</h1>
                    <h1 style="font-size: 24px;">Event Location: {{ $event->location }}</h1>
                    <h1 style="font-size:24px;">Total Participants: {{ $event->users()->count() }}</h1>
<br>
	...
	<table class="table table-bordered" style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr>
                                <td style="border: 1px solid #ddd; padding: 8px;">{{ $index + 1 }}</td>
                                    ...
                                    <td>
                <a href="{{ asset('storage/' . $user->proof) }}" target="_blank">View Proof</a>
            </td>
                                </tr>
                            @endforeach
                        </tbody>
